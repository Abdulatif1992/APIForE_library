                        ...
                        @foreach($books as $book)
                            <tr>
                                ...
                                <td rowspan="2" class="align-middle">
                                    @if($book->status)
                                        <img src="{{ asset('storage/img/check1.png')}}" height=15>
                                    @else
                                        <a  data-bs-toggle="modal" data-bs-target="#myModalConfirm" onclick="confirmbook({{$book->book_id}})"><button type="button" class="btn btn-light"><img src="{{ asset('storage/img/confirm.png')}}" height=30></button></a>
                                        <a  data-bs-toggle="modal" data-bs-target="#myModalDelete" onclick="deletebook({{$book->book_id}})"><button type="button" class="btn btn-light"><img src="{{ asset('storage/img/remove.png')}}" height=30></button></a>
